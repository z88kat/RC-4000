...
//
// Add scheduled alarm data to the watch using the given ID which is the label
//
...
//
// Update scheduled alarm data to the watch using the given ID which is the label
//
const updateScheduledAlarmData = (id, index, name, day = 1, month = 1, time = '12:00 AM') => {
